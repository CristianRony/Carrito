            ...
            public void onClick(View v) {
                Thread tr=new Thread() {
                    ...
                    public void run() {
                        ...
                        String URL = "http://192.168.43.178/Publicaciones/WebServiceCarrito.asmx";
                        String METHOD_NAME = "InsertarUsusarios ";
                        String SOAP_ACTION = "http://tempuri.org/InsertarUsusarios ";
                        ...
                        try {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(getApplicationContext(),"Usuario Reagistrado",Toast.LENGTH_LONG).show();
