...
public class Adaptador extends RecyclerView.Adapter<Adaptador.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.with(context).load("http://192.168.1.35/Publicaciones/Imagenes/"
                +lista.getImg()).resize(400,400).into(holder.img);
    ...
    public static void setOnItemClickListener(OnItemClickListener
                                                        onItemClickListener) {
